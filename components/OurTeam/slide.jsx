            ...
            <div className="w-full flex flex-col justify-center justify-items-center h-full">
                <div className="w-full ">
                    <div className="w-[100px] lg:w-[140px] h-[100px] lg:h-[140px] bg-secondary-600 rounded-full mx-auto relative overflow-hidden">
                        <Image src={person.img_url||'/images/default-user.png'} alt={`${person.member_name} ${person.member_last_name}`} fill />
                    </div>
                    ...
                    <p className="text-center font-[400] text-[10px] lg:text-xs text-typoLight-200 mb-5 lg:mb-10">{person.job || 'Developer'}</p>
                    <div className="flex text-center justify-center justify-items-center gap-3">
                        <a href={`mailto:${person.email}`} ><div className="w-6 lg:w-7 h-6 lg:h-7 relative"><i className="icon-message leading-6 lg:leading-7 w-full h-full text-center block text-2xl text-typoLight-200 dark:text-typoDark-400 hover:text-primary-400 transition" ></i></div></a>
                        <a href={person.github} ><div className="w-6 lg:w-7 h-6 lg:h-7 relative"><i className="icon-github leading-6 lg:leading-7 w-full h-full text-center block text-2xl text-typoLight-200 dark:text-typoDark-400 hover:text-primary-400 transition" ></i></div></a>
