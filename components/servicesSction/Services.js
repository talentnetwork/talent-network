...
const Services = () => {
  return (
    <div>
      <div
        className='mt-16 block  md:mt-10 md:grid grid-cols-7 gap-4'
        id='#services'
      >
        <div className='md:col-span-3'>
          ...
          <p className='mt-16 mb-10 w-[318px] md:w-auto '>
            We are here to provide services in the field of website design such
            as: front-end development, back-end development and user interface
            design. The Talent Network team from zero to one hundred sets up
            dedicated sites with laravel, nextjs, and reactjs technologies with
            a dedicated user interface design. Click for more information.
          </p>
